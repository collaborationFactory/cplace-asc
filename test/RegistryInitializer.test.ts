...
describe('configuring jfrog credentials', () => {
    ...
    const npmrcConfigured_old_registry =
        '@cplace-next:registry=https://cplace.jfrog.io/artifactory/api/npm/cplace-npm-local/\n' +
