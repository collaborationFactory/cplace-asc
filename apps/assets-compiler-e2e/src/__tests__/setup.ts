...
beforeAll(() => {
  ...
  console.log('Checking for assets-compiler.sh:', fs.existsSync(assetsCompilerSh));
  console.log('Checking for assets-compiler.cmd:', fs.existsSync(assetsCompilerCmd));
